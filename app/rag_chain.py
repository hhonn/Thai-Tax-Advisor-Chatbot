...
BM25_PATH = os.path.join(
    os.path.dirname(__file__), "..", "data", "processed", "bm25_index.pkl"
)
...
def answer_question(
    question: str, user_history: List[Tuple[str, str]] = None
) -> Tuple[str, str]:
    ...
    try:
        resp = openai_client.chat.completions.create(messages=messages, **MODEL_ARGS)
